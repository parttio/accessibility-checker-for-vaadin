 ...
 */
public class AltTextVisitor
        extends GenericVisitorAdapter<ExpressionStmt, String>  implements GenericStringVisitor{

    public static final String METHOD_NAME = "setAlt";
    private final SimpleName methodName = new SimpleName(METHOD_NAME);
    public static final LineComment COMMENT = new LineComment("<accessibility-plugin-alt-text>");
